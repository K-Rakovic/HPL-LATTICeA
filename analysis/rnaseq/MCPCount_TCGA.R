...
pdf(file="C:\\Users\\krakovic\\OneDrive - University of Glasgow\\Temposeq\\TCGA_20250424\\TCGA_MCPCOUNTER_250424.pdf", width = 5, height = 3)
...
pdf(file="C:\\Users\\krakovic\\OneDrive - University of Glasgow\\Temposeq\\TCGA_20250424\\TCGA_MCPCOUNTER_250424_stats.pdf", width = 4.6, height = 4)
draw(p, heatmap_legend_side = "left", annotation_legend_side = "left", padding = unit(c(2, 2, 2, 2), "mm"))
dev.off()
